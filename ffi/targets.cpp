...
inline TargetLibraryInfoImpl *unwrap(LLVMTargetLibraryInfoRef TLI) {
    return reinterpret_cast<TargetLibraryInfoImpl *>(TLI);
}
...
API_EXPORT(long long)
LLVMPY_ABISizeOfElementType(LLVMTargetDataRef TD, LLVMValueRef Val) {
  llvm::Value* UW = llvm::unwrap(Val);
  llvm::GlobalValue* GV = llvm::dyn_cast<llvm::GlobalValue>(UW);
  ...
  return (long long) LLVMABISizeOfType(TD, llvm::wrap(GV->getValueType()));
}

API_EXPORT(long long)
LLVMPY_ABIAlignmentOfElementType(LLVMTargetDataRef TD, LLVMValueRef Val) {
  llvm::Value* UW = llvm::unwrap(Val);
  llvm::GlobalValue* GV = llvm::dyn_cast<llvm::GlobalValue>(UW);
  ...
  return (long long) LLVMABIAlignmentOfType(TD, llvm::wrap(GV->getValueType()));
}
...
API_EXPORT(void)
LLVMPY_AddTargetLibraryInfoPass(LLVMTargetLibraryInfoRef TLI,
                                LLVMPassManagerRef PM) {
  llvm::unwrap(PM)->add(new llvm::TargetLibraryInfoWrapperPass(*(llvm::unwrap(TLI))));
}
